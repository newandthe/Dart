...
void constantExample() {
  ...
  // 위 문장은 $은 var 객체로 사용 불가능하다는 예시. 컴파일 에러 발생.
}

void booleanExample() {
  // Check for an empty string.
  print("var fullName = ''; print(fullName.isEmpty)");
  var fullName = '';
  print(fullName.isEmpty);

  // Check for zero.
  print("var hitPoints = 0;");
  var hitPoints = 0;
  print(hitPoints <= 0);
  ...
  print("var iMeantToDoThis = 0 / 0; print(iMeantToDoThis.isNaN)");
